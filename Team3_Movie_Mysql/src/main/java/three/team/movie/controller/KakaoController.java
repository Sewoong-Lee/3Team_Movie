...
//	@GetMapping("/kakao")
//    public void kakaoPayform() throws Exception {
//        
//    }
...
//    }
    ...
    public String kakaoPay(Mv_sales mv_sales, HttpSession session, Model model, HttpServletRequest request) throws Exception {
...
//    	String user_id = "ddd"; //아이디 잠깐 하드코딩
    ...
    public String kakaoPaySuccess(@RequestParam("pg_token") String pg_token, Model model,@ModelAttribute("mv_sales") Mv_sales mv_sales) throws Exception {
    ...
    public String kakaoPayCancel(Model model) throws Exception {
    	String msg = "결제 취소";
    ...
    public String kakaoPaySuccessFail(Model model) throws Exception {
    	String msg = "결제 실패";
