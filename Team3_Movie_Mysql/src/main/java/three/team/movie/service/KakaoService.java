...
public class KakaoService {
	...
	public String kakaoPayReady(Mv_sales mv_sales, String path)  throws Exception {
        ...
        params.add("approval_url", "http://118.67.135.173:8080"+path+"/kakaoPaySuccess");
        params.add("cancel_url", "http://118.67.135.173:8080"+path+"/kakaoPayCancel");
        params.add("fail_url", "http://118.67.135.173:8080"+path+"/kakaoPaySuccessFail");
    ...
    public static KakaoPayApprovalVO kakaoPayInfo(String pg_token, Mv_sales mv_sales)  throws Exception {
