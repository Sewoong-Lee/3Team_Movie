...
public class MovieDataServiceImpl implements MovieDataService{
	...
	@Override
	public Map<String, Object> selectList(Mv_Page page)throws Exception {
	...
	//메인 리스트 
	@Override
	public Map<String, Object> selectMainList(Mv_Page page) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
	...
	//페이징 처리 
	public Mv_Page paging(Mv_Page page,int totCnt)throws Exception {
//		//영화 전체 구하기
//		int totCnt = movieDataDAO.selectTotCnt(page);
...
//		int statNum = (curPage-1)*page.getPerPage()+1;
		int statNum = (curPage-1)*page.getPerPage();
	...
	@Override
	public Map<String, Object> replyPaging(int movie_num, int curPageReply)throws Exception {
		//게시물 총 수 구하기 
