	...
	<table>
		<tr>
			<td rowspan="7" align="center">
				<div class = "imgBox">
					<c:if test="${member.file_name ne  ''}">
						<img src = "${path}/uploadimg/${member.file_name}" id = "profile"><br>
					</c:if>
					<c:if test="${member.file_name eq  ''}">
		...
		<tr>
			...
			<td>
				<button onclick="location.href = '${path}/user/changePw?user_id=${member.user_id}'" class = "btn">변경하기</button>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><button id = "withdraw" class = "btn">탈퇴하기</button></td>
		</tr>
	</table>
	</fieldset>
</div>
